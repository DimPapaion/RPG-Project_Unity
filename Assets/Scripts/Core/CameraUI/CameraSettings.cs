...
namespace Scripts.Core.CameraUI
{
    public class CameraSettings : MonoBehaviour
    {
        ...
        void Reset()
        {
            Transform keyboardAndMouseCameraTransform = transform.Find("MouseFreeLook");
            ...
            if (playerController != null && playerController.tag == "Player")
            {
